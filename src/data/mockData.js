export const MOCK_SHOWS = [
  ...
  },
  {
    ...
    genre: ["Drama", "Comedy"],
    releaseYear: 2018,
    description: "The Roy family controls one of the biggest media and entertainment conglomerates in the world. Their fight for power plays out in brutal family dynamics.",
    posterUrl: "https://image.tmdb.org/t/p/w500/e2X4vnDdan9Do0G7Ez0XT0J8qLx.jpg",
    rating: 8.8,
  },
  {
    _id: "9",
  ...
  },
  {
    ...
    releaseYear: 2024,
    description: "In feudal Japan, a ship of European sailors arrives, setting off a conflict between rival lords that will reshape the nation.",
...
export const MOCK_REVIEWS = {
  "1": [
    { _id: "r1", username: "alex_w", rating: 9, reviewText: "Mind-bending masterpiece. Nolan at his absolute best." },
    { _id: "r2", username: "sarah_k", rating: 8, reviewText: "Visually stunning. The concept is brilliant even if the ending is debatable." },
  ],
  "2": [
    { _id: "r3", username: "moviebuff99", rating: 10, reviewText: "The best TV show ever made, no contest." },
    { _id: "r4", username: "alex_w", rating: 10, reviewText: "Walter White's arc is unmatched in television history." },
  ],
  "4": [
    { _id: "r5", username: "sarah_k", rating: 9, reviewText: "Pedro Pascal carries this show effortlessly. Absolutely gripping." },
  ],
  "9": [
    { _id: "r6", username: "moviebuff99", rating: 10, reviewText: "Heath Ledger's Joker alone makes this a 10/10." },
    { _id: "r7", username: "cinema_lover", rating: 9, reviewText: "Still the best superhero film ever made." },
  ],
};

export const MOCK_WATCHLIST = [
  { _id: "w1", show: MOCK_SHOWS[1], status: "Watching",      progress: 4 },
  { _id: "w2", show: MOCK_SHOWS[3], status: "Plan to Watch", progress: 0 },
  { _id: "w3", show: MOCK_SHOWS[5], status: "Completed",     progress: 10 },
  { _id: "w4", show: MOCK_SHOWS[7], status: "Watching",      progress: 2 },
  { _id: "w5", show: MOCK_SHOWS[0], status: "Completed",     progress: 0 },
];
